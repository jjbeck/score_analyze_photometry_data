...
def save_food_drop(plt, photometryData, photometryDataSem, objectData, objectDataSem, 
photometryDataNorm, photometryDataSemNorm, objectDataNorm, objectDataSemNorm,directory, filename):
    ...
    try:
        plt_title = plt_title[0] + ' ' + plt_title[1] + ' ' +  plt_title[2] + ' ' +  plt_title[3] + ' ' +  plt_title[4]
    except:
        plt_title = plt_title[0] + ' ' + plt_title[1] + ' ' +  plt_title[2] + ' ' +  plt_title[3]
    plt.title(plt_title)
    ...
    plt.axvline(0)
    plt.legend(['Food Drop', 'Object Drop'])
    

    #save figure to file
    plt.savefig(directory + '/' + plt_title + '_zscore' + '.png')
    ...
    #plot and format additional figure elements
    plt.axvline(0)
    plt.legend(['Food Drop', 'Object Drop'], loc='upper right')
    

    #save figure to file
    plt.savefig(directory + '/' + plt_title + '_normalized' + '.png')